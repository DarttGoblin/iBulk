...
// Set initial styling for the first or previous chosen category
var numberOfCategory = localStorage.getItem("numberOfCategory");
if (numberOfCategory == null) {StyleWorkoutButtonsHoverOn(workoutButtons[0]);}
else {StyleWorkoutButtonsHoverOn(workoutButtons[numberOfCategory]);}

//  State The Difference Of Pages Scale
...
//	Style First And Last Element's Border
